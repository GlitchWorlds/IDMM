...
**Rewards Cost Pill — "200 star item"**
- Background: transparent
- Border: `1px solid #cba258` (Gold)
- Text: `#cba258` (Gold)
- Radius: `50px` (full pill)
- Padding: `4px 12px`
- Content: "200 star item" where ` star` is a small filled star glyph — indicates the Rewards Stars required to redeem this item
